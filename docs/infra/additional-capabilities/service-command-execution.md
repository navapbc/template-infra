...
* You'll need to have [set up infrastructure tools](/docs/infra/getting-started/set-up-infrastructure-tools.md), like Terraform, AWS CLI, and AWS authentication
* You'll need to have set up the [app environments](/docs/infra/getting-started/set-up-app-env.md)
