...
To make changes to the role manager such as updating dependencies or adding functionality, see [database access control](/docs/infra/reference/database-access-control.md#update-the-role-manager)
