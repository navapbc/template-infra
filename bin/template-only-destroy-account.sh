...
sed -i .bak 's/resource "aws_s3_bucket" "tf_state" {/&\n  force_destroy = true/' ../../modules/modules/terraform-backend-s3/main.tf
sed -i .bak 's/resource "aws_s3_bucket" "tf_log" {/&\n  force_destroy = true/' ../../modules/modules/terraform-backend-s3/main.tf
sed -i .bak 's/prevent_destroy = true/prevent_destroy = false/g' ../../modules/modules/terraform-backend-s3/main.tf
